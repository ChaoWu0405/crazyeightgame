...
Original: 24 - Sept - 2019
Updated: 10 - Oct - 2019


The following code contains a 3 player Yahtzee game

The 3 players connect to a central server. 
Each player gets to play a round of the Yahtzee game in a turn based game. There are 13 rounds and the rounds go in order Player 1 - 2 - 3. At the end of the game bonuses are added and a winner is displayed. At every turn the server knows the score of all the players and displays it as well as the current round number. 
